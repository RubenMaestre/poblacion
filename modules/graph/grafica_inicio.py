...
def grafica_rango_years(df_continentes):
    ...
    # Filtrar años que realmente existen en el DataFrame para los tickvals
    ...
    fig.update_xaxes(
        tickvals=[df_continentes[df_continentes['Year'] == year]['Year_Label'].iloc[0] for year in tickvals if year in df_continentes['Year'].values],
        ticktext=ticktext
    )
